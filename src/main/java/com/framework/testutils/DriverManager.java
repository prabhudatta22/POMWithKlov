...
public class DriverManager {
	...
	public static void maximizeBrowser(WebDriver driver) {
		...
		if (TestSetUp.configProperty.getProperty("isPortable").equalsIgnoreCase("yes")) {

			String viewX = StringUtils.isEmpty(TestSetUp.viewportX)
					? TestSetUp.configProperty.getProperty("viewportX")
					: TestSetUp.viewportX;
			String viewY = StringUtils.isEmpty(TestSetUp.viewportY)
					? TestSetUp.configProperty.getProperty("viewPortY")
					: TestSetUp.viewportY;
			System.out.println("CMD values X " + TestSetUp.viewportX);
			System.out.println("CMD values Y " + TestSetUp.viewportY);

			System.out.println("Prop values X " + TestSetUp.configProperty.getProperty("viewportX"));
			System.out.println("Prop values Y " + TestSetUp.configProperty.getProperty("viewPortY"));
